...
from pamap2.preprocessing import bpf
...
def get_dataset(train_persons, test_persons, frame_size, activities, attributes, positions, axes, preprocesses=None):
    ...
    pamap2 = PAMAP2('data_cache/PAMAP2_Dataset/Protocol/', cache_dir='data_cache/cache/')
...
for model_name in model_list:
    ...
    for person in all_persons:
        ...
        for cut_off in [10, 20, 30, 40]:
            ...
            bpf_fn = lambda x: bpf(x, (cut_off, cut_off+10), 100)
            # ds = lambda x: downsampling(x, rate=(int(50/cut_off)))
            train_loader, test_loader = get_dataset(train_persons, test_persons, frame_size, activities, attributes, positions, axes, [bpf_fn])
