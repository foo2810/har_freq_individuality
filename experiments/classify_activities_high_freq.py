...
def get_dataset(pamap2, h_fpass, frame_size, activities, attributes, positions, axes):
    ...
    ret = pamap2.framing(frame_size, train_persons, activities, attributes, positions, axes, preprocesses=[high_pass_filter_fn])
    ...
    ret = pamap2.framing(frame_size, test_persons, activities, attributes, positions, axes, preprocesses=[high_pass_filter_fn])
